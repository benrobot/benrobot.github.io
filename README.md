# Forked from https://github.com/robhinds/robhinds.github.io

## Generated Site
You can checkout the page generated for this repo here: https://benrobot.github.io
...
3. Update `/_config.yml` and `/_data/resume.yml` with the details of your CV - the comments will explain what is required
...
If you already have Ruby but not Jekyll then run the following command:
```
